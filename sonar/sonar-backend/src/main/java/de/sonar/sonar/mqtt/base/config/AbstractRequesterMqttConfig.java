...
public abstract class AbstractRequesterMqttConfig {
    ...
    public MessageHandler mqttRequestOutbound(
        ...
        MqttPahoMessageHandler handler = new MqttPahoMessageHandler("requestPublisherClient_" + getTopic(), factory);
    ...
    public MqttPahoMessageDrivenChannelAdapter mqttReplyInbound(
        ...
        MqttPahoMessageDrivenChannelAdapter adapter =
                new MqttPahoMessageDrivenChannelAdapter(
                        "responseReceiverClient_" + getTopic(), factory, "reply/topic/" + getTopic());

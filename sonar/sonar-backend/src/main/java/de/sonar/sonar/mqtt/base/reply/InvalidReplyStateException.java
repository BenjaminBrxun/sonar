...
public class InvalidReplyStateException extends RuntimeException {
    ...
    /**
     * Constructs a new {@link InvalidReplyStateException} with the specified detail message and cause.
     *
     * @param message the detail message explaining the reason for the exception
     * @param cause   the cause of the exception
     */
    public InvalidReplyStateException(String message, Throwable cause) {
        super(message, cause);
    }

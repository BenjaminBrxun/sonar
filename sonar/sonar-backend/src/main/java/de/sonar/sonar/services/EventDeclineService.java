...
public class EventDeclineService extends AbstractMqttReplyService<Event, Event> {
    ...
    public EventDeclineService(
            @Qualifier("decline-event_mqttReplyOutboundChannel") MessageChannel mqttReplyOutboundChannel,
    ...
    @ServiceActivator(inputChannel = "decline-event_mqttRequestInboundChannel")
    @Override

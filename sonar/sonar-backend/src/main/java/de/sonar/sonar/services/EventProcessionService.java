...
public class EventProcessionService extends AbstractMqttReplyService<Event, Event> {
    ...
    public EventProcessionService(
            @Qualifier("process-event_mqttReplyOutboundChannel") MessageChannel mqttReplyOutboundChannel,
    ...
    @ServiceActivator(inputChannel = "process-event_mqttRequestInboundChannel")
    @Override

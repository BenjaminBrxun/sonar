    ...
    return <>
        <div className="sonar-body">
            ...
            <div className="sonar-content card-container">
                ...
                {events.map((event) => (<EventCardModule costs={event.price} date={event.startDate} image={eventCardImagePark} restricted={event.restricted} title={event.name} id={event.id}/>)
                )}
